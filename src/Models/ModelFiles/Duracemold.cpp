...
#define HardenedCementChemistry_DATABASE DEFAULT
...
/** Compute the secondary variables from the primary ones. */
{
  ...
  /* Solve cement chemistry */
  {
    ...
    T psi      = val.U_charge ;
    //T loga_w = 0;
    T loga_w = val_n.Log10WaterActivity;
    ...
    HardenedCementChemistry_ComputeSystem(hcc);
